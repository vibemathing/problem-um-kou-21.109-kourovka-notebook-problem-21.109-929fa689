...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.109"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-v1",
      "problem_contract_sha256": "df8f84d66fa60de1831cf758b5362ccdb880401557be012be4d186425ac93a8d",
      "problem_id": "problem:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689",
      "route_id": "route:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-source-fidelity-01",
      "graph_id": "graph:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture: The derived length of a finite solvable group $G$ does not exceed $|\\operatorname{Cod}(G)|-1$."
          },
          "statement_sha256": "59abc190879fa80fa446888fb0c3f4dc44fc22017302e8c06cf162c477aaaaa9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-root",
      "route_id": "route:um-kou-21.109-kourovka-notebook-problem-21.109-929fa689-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.109-54393457d339",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.109"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
